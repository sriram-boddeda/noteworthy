...
export function getInitialData(): { notes: Note[], folders: Folder[] } {
    ...
    const initialNotes: Note[] = [
      ...
      { id: uuidv4(), title: 'Grocery List', type: 'richtext', tags: ['home', 'shopping'], content: '<h2>Grocery List</h2><ul><li>Milk</li><li>Bread</li><li>Eggs</li><li>Cheese</li></ul>', folderId: null },
    ];
